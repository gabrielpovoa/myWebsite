...
import bune from '../../public/bune.png';
        ...
        >
            <div className="flex items-center justify-center">
                <div className='relative'>
                    ...
                    >
                        <Image
                            src={myself}
                            alt='João Gabriel, portfolio owner, smiling, with a green sweter'
                            width="192"
                            height="192"
                            quality="95"
                            priority={true}
                    ...
                    >
                        <Image
                            ...
                            height="192"
                            quality="95"
                            className='h-6 w-6  object-cover shadow-xl'
                        />
                    </motion.span>
                </div>
            </div>
            ...
            >
                ...
                <a
                    ...
                    href="https://www.linkedin.com/in/gabriel-limapovoa/"
                    target="_blank"
                >
                    <BsLinkedin />
                </a>
                ...
                <a
                    ...
                    href="https://github.com/gabrielpovoa"
                    target="_blank"
                >
                    <FaGithubSquare />
                </a>
